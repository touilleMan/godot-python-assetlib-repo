...
cdef class _Marshalls(Reference):
    @staticmethod
...
cdef class ResourceFormatSaverCrypto(ResourceFormatSaver):
    @staticmethod
    cdef ResourceFormatSaverCrypto from_ptr(godot_object *_ptr)


cdef class ResourceFormatLoaderCrypto(ResourceFormatLoader):
    @staticmethod
    cdef ResourceFormatLoaderCrypto from_ptr(godot_object *_ptr)
